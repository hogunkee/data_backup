...
def main():
    ...
    if exist('total_data'):
        ...
        titles_seq = pad_sequences(tokenizer.texts_to_sequences(train_titles), maxlen=TITLE_LEN)
        texts_seq = pad_sequences(tokenizer.texts_to_sequences(train_texts), maxlen=TEXT_LEN)
        ...
        total_data = [train_titles, train_texts, train_labels, test_titles, test_texts, test_labels]
        return total_data
